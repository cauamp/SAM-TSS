...
class rtmvss(nn.Module):
    def __init__(self, args, device):
        ...
        self.sparse_embed1 = nn.Linear(self._bb_feat_sizes[-1][0] * self._bb_feat_sizes[-1][1], 256)
        self.sparse_embed2 = nn.Linear(self.class_query_size + 256, 256)
    ...
    def _forward_internal(self, imgs, depths, is_mem=True, is_training=True, current_ti=0):
        ...
        # print(f"Input dimensions - imgs: {imgs.shape}, depths: {depths.shape}")  # Debug print
        ...
        if is_training:
            ...
            for ti in range(0, frames):
                ...
                sparse_embeddings1 = self.sparse_embed1(
                        sparse_embeddings_expanded) # [B*C, Q, 256]
                
                sparse_embeddings = self.sparse_embed2(
                        torch.cat([sparse_embeddings1, class_queries_expanded], dim=2) 
                        )# [B*C, Q, 256]
