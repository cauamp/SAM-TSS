...
--backbone deeplab50 --training --baseline-mode --gpus 2 --lr-start 2e-4 --lr-strategy plateau_08 --num-epochs 150 --batch-size 2 --stm-queue-size 3 --sample-rate 3 --savedir save/training_base_deeplab
